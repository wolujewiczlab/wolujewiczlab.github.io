    ...
    <div class="tone-light">
        ...
        <div class="research-highlight-box">
            <div class="highlight-text">
                <p>Spina bifida is a complex congenital condition whose genetic causes extend beyond traditional protein-coding mutations. In this study, we applied advanced computational genomics and deep-learning approaches to uncover how subtle changes in the regulatory regions of the genome can disrupt early neural tube development. By integrating whole-genome sequencing, transcription factor binding maps, and three-dimensional chromatin architecture, we identified rare regulatory variants that alter gene expression programs essential for nervous system formation. These findings highlight the importance of non-coding DNA in human birth defects and provide a new framework for precision-medicine approaches to understanding and ultimately preventing neural tube defects.</p>
            </div>
...
<div id="public-health-metagenomics" class="two-tone-section section-metagenomics">
    ...
    <div class="tone-light">
        ...
        <div class="research-highlight-box">
            <div class="highlight-text">
                <p>This study presents a portable, real-time genomic surveillance pipeline using Oxford Nanopore long-read sequencing to enable unbiased detection of tick-borne pathogens directly from blacklegged ticks. Working in partnership with the Connecticut Agricultural Experiment Station (CAES), we developed and validated a metagenomic workflow capable of simultaneously identifying bacterial, protozoal, and viral pathogens while preserving quantitative signal. The approach demonstrates strong precision, supports future strain-level genomic resolution, and illustrates how next-generation sequencing can enhance public health surveillance and early detection of emerging vector-borne disease threats.</p>
            </div>
            <div class="highlight-visual">
